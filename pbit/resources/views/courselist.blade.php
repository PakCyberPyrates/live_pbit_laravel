...
<div class="beginner-course begin">
		  @foreach($courselist as $lists) 		  
				...
				$video = App\Helper::get_link($lists->video->url,'course');      
		...
		<div class="{{ strtolower($lists->course_name) }}-course courselisting">			
			<div class="container">
				<div class="row ">
					<div class="col-md-5 new_bx_left">
						<div class="bx-1eft">
							...
							<div class="outerr">
							    ...
							    <div class="view_video btn btn-info btn-lg" getitem="" v-url="{{$video}}"><img src="{{url('/public/frontview/images/play_btnn.png')}}" alt="img" class="play-btn"/></div>	
							</div>
					...
					<div class="col-md-7">
						<div class="bx-right">						
							<p class="demi_text margin-tp">{{ ucfirst($lists->course_title) }}</p>
								...
								<form  class="formcart courselistsection" method="POST" action="{{url('cart')}}">
