                                  ...
                                  <div class="form-group">
                                    ...
                                    <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" placeholder="{{ __('Password') }}">
                                     <span id="pnit-id-password-error"></span>
                				        ...
                				        <div class="form-group">
                				          <div class="form-control g-recaptcha"  data-sitekey="6Ld2zHwUAAAAACrIEQgpR0bT57UzwgQxRh8sN0Ro"></div>
                                  <!-- <div class="form-control g-recaptcha" data-theme="light" data-sitekey="6Ld2zHwUAAAAACrIEQgpR0bT57UzwgQxRh8sN0Ro" style="transform:scale(0.77);-webkit-transform:scale(0.77);transform-origin:0 0;-webkit-transform-origin:0 0;"></div> -->
