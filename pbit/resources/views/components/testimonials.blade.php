...
@if(count($testimonialData)>0)
  <div class="testimonials">
        <div class="container mt-3">
            <h2 class="heading_text">What our students have to say</h2>
            ...
            <div class="carousel-inner">
                ...
                @endphp                     
                    <div class="carousel-item {{$active}}">
                        <div class="testimonial-image-user"><img src="{{ url($userImg)}}" alt="stundent"  class="student_img"></div>
                        ...
                        <p>“{{ str_limit(strip_tags($testimonial->text), 200) }}” </p>                    
