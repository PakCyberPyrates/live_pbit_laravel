									...
									<section class="card card-featured-left card-featured-secondary">
										<div class="card-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Total Orders Amount</h4>
														<div class="info">
															<strong class="amount">$ {{$orders_amount}}</strong>
														</div>
													</div>
													<div class="summary-footer">
														@if($all_users)
														<a class="" href="{{url('admin/orders')}}">View orders <i class="fa fa-arrow-right" aria-hidden="true"></i>
                                                        </a>
                                                        @endif
													</div>
												</div>
									...
									<div class="row">
										<div class="col-xl-12">
											<div class="chart-data-selector" id="salesSelectorWrapper">
												...
												<?php 
												$Beginner =  App\Order::sales(1);
												$Intermediate =  App\Order::sales(2);
												$Advance =  App\Order::sales(3);

												?>
												<h2>
													Sales of <?php echo date('Y'); ?> :
													<strong>
														<select class="form-control" id="salesSelector">
															<option value="Porto Admin" selected>Beginner</option>
															<option value="Porto Drupal" >Intermediate</option>
															<option value="Porto Wordpress" >Advanced</option>
														</select>
													</strong>
												</h2>
