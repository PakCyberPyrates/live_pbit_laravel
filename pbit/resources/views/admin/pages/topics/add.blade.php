...
<div class="row">
	<div class="col">
		<section class="card">
			...
			<div class="card-body">
				<form class="form-horizontal form-bordered" id="topics-form" action="{{ action('TopicController@store')}}" method="post" enctype="multipart/form-data">
					@csrf
...
<script type="text/javascript">	
  ...
  $(document).ready(function(){
  	...
  	$('#topics-form').bootstrapValidator({
        ...
        fields: {
            ...
            trailer_video:{
            	validators: {
                    notEmpty: {
                         message: 'Please upload a trailer video'
                    }
                }
            },
            'document[]':{
