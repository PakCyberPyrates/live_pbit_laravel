...
class PaypalGatewaysController extends Controller
{
	...
	function redirect($totalamount, $randtoken)
	{
		...
		<input type="hidden" name="invoice" value="'.$randtoken.'">  
		<input type="hidden" name="return" value="'.url("/payment/success?token=".$randtoken."").'">
